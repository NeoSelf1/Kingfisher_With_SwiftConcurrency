...
public class SessionDataTask: @unchecked Sendable {
    ...
    public var mutableData: Data {
        ...
        NeoLogger.shared.info("mutableData accessed")
    ...
    var callbacks: [SessionDataTask.TaskCallback] {
        lock.lock()
        defer { lock.unlock() }
        NeoLogger.shared.info("callbacks called")
    ...
    func addCallback(_ callback: TaskCallback) -> CancelToken {
        ...
        NeoLogger.shared.info("addCallback called - callback: \(callback)")
    ...
    func removeCallback(_ token: CancelToken) -> TaskCallback? {
        ...
        NeoLogger.shared.info("removeCallback called for token: \(token)")
